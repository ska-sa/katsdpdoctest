    ...
    stages {
	    ...
	    environment {
		  ...
		  for file in ${FILES[@]}; do
		    echo;
		    echo "> Uploading ${file}";
		    docker run --rm -i -v=`pwd`:/docs sdp-docker-registry.kat.ac.za:5000/docker-base-build ls /docs
		    docker run --rm -i -v=WORKING_DIR:/docs sdp-docker-registry.kat.ac.za:5000/docker-base-build ls /docs
